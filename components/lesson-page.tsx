  ...
  return <div className="lesson-shell"><div className="lesson-canvas">
    ...
    <div className="lesson-layout">
      ...
      <main className="lesson-main">
        ...
        <LessonVideo courseId={course?._id ?? null} courseSlug={course?.slug ?? null} durationSeconds={lesson.durationSeconds} lessonId={lesson._id} lessonSlug={lesson.slug} lessonTitle={lesson.title} posterUrl={lesson.poster?.asset?.url ?? null} videoUrl={lesson.videoUrl} startSeconds={startSeconds} />
